<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" import="modelo.Destino" import="modelo.Login"
	import="java.util.List"%>
	
<% List<Destino> lista = (List<Destino>) request.getAttribute("lista"); %>
						...
						<div class="card" style="border-radius: 15px; width: 70rem;">
							<div class="card-body p-5">
								<ul class="nav nav-tabs">
									<li class="nav-item"><a class="nav-link"
										href="./crud/destinos.jsp">Cadastrar</a></li>
									<li class="nav-item"><a class="nav-link active"
										aria-current="page" href="./DestinoLista">Consulta</a></li>
									<li class="nav-item"><a class="nav-link"
								...
								<tbody>
										...
										<tr>
											...
											<td><%=d.getCidade()%></td>
											<td class="d-flex"><a
												href="./DestinoUpdate?id=<%=d.getIdDestino()%>"
												class="btn btn-primary">Editar</a> <a
												href="./DestinoDel?id=<%=d.getIdDestino()%>"
