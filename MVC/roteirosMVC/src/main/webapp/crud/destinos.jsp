						...
						<div class="card-body p-5">
							<ul class="nav nav-tabs">
								<li class="nav-item"><a class="nav-link active"
									href="destinos.jsp">Cadastrar</a></li>
								<li class="nav-item"><a class="nav-link"
							...
							<br>
							<form action="../DestinoCadastro" method="get" class="form-control">
									<legend>Cadastro Destino</legend>

									<label for="pais">Pais:</label> 
									<input type="text" id="pais"
										name="pais" size="40" class="form-control" required> <br>
										
										
									<label for="cidade">Cidade:</label> 
									<input type="text"
										id="cidade" name="cidade" size="15" class="form-control"
										required> <br> 
