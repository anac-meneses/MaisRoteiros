						...
						<div class="card" style="border-radius: 15px;">
							<div class="card-body p-5" >
								<ul class="nav nav-tabs">
									<li class="nav-item"><a class="nav-link"
										href="./crud/cliente.jsp">Cadastrar</a></li>
									<li class="nav-item"><a class="nav-link "
										aria-current="page" href="./ClienteLista">Consulta</a></li>
									<li class="nav-item"><a class="nav-link"		
										href="./crud/homeADM.jsp">Home ADM</a></li>
									<li class="nav-item"><a class="nav-link active"
										href="./ClienteUpdate">Atualizar</a></li>
								</ul>
								<br>

								<form action="./ClienteEdit" class="form-control">
									<legend>Dados para Atualizar</legend>

									<label for="nome">Nome:</label> <input type="text" id="nome"
										name="nome" size="40" class="form-control"
										value="<%=request.getAttribute("nome")%>" required> <br>


									<label for="telefone">Telefone:</label> <input type="tel"
										id="telefone" name="telefone" size="15" class="form-control"
										value="<%=request.getAttribute("telefone")%>" required>
									<br> <label for="cpf">CPF:</label> <input type="number"
										id="cpf" name="cpf" size="20" class="form-control"
										value="<%=request.getAttribute("cpf")%>" required> <br>

									<label for="email">Email:</label> <input type="text" id="email"
										name="email" size="50" class="form-control"
										value="<%=request.getAttribute("email")%>" required>
									<br> <label for="senha">Senha:</label> <input
										type="password" id="senha" name="senha" size="50"
										class="form-control"
										value="<%=request.getAttribute("senha")%>" required><br>
										<label for="senha">Tipo de Login:</label> 
										<input
										type="number" id="senha" name="login" size="50"
										class="form-control"
										value="Tipo atual: <%=request.getAttribute("login")%>" required><br>
