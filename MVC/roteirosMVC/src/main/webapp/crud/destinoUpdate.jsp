...
<title>Atualizar Destinos</title>
<link rel="stylesheet"
						...
						<div class="card" style="border-radius: 15px;">
							<div class="card-body p-5" >
								<ul class="nav nav-tabs">
									<li class="nav-item"><a class="nav-link"
										href="./crud/destino.jsp">Cadastrar</a></li>
									<li class="nav-item"><a class="nav-link "
										aria-current="page" href="./DestinosLista">Consulta</a></li>
									<li class="nav-item"><a class="nav-link"		
										href="./crud/homeADM.jsp">Home ADM</a></li>
									<li class="nav-item"><a class="nav-link active"
										href="./DestinoUpdate">Atualizar</a></li>
								</ul>
								<br>

								<form action="./DestinoEdit" class="form-control">
									<legend>Dados Destino</legend>

									<label for="id">ID Destino:</label> <input type="number" id="idDestino"
										name="idDestino" size="40" class="form-control"
										value="<%=request.getAttribute("idDestino")%>" readonly> <br>


									<label for="pais">Pais:</label> <input type="text"
										id="pais" name="pais" size="30" class="form-control"
										value="<%=request.getAttribute("pais")%>" required>
									<br> 
									
									<label for="cidade">Cidade:</label> 
									<input type="text" id="cidade" name="cidade" size="50" class="form-control"
										value="<%=request.getAttribute("cidade")%>" required> <br>
