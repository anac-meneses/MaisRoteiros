						...
						<div class="card-body p-5">
							<ul class="nav nav-tabs">
								<li class="nav-item"><a class="nav-link active"
									href="compras.jsp">Cadastrar</a></li>
								<li class="nav-item"><a class="nav-link"
							...
							<br>
							<form action="../CompraCadastro" method="get" class="form-control">
									<legend>Cadastro Compras</legend>

									<label for="cpf">CPF:</label> 
									<input type="text" id="cpf" name="cpf" size="40" class="form-control" required> <br>
										
										
									<label for="idPacote"> ID Pacote:</label> 
									<input type="number" id="idPacote" name="idPacote" size="15" class="form-control"
										required> <br> 
									
									<label for="quantidade">Quantidade:</label> 
									<input type="number" id="quantidade" name="quantidade" size="40" class="form-control" required> <br>
									
									<label for="valor">Valor:</label> 
									<input type="text" id="valor" name="valor" size="40" class="form-control" placeholder="O valor é atribuido de acordo com o pacote" readonly> <br>
									
									<label for="data">Data:</label> 
									<input type="text" id="data" name="data" size="40" class="form-control" required> <br>
