						...
						<div class="card-body p-5">
							<ul class="nav nav-tabs">
								<li class="nav-item"><a class="nav-link active"
									href="cliente.jsp">Cadastrar</a></li>
								<li class="nav-item"><a class="nav-link"
							...
							<br>
							<form action="../CadastroClienteADM" method="get" class="form-control">
									<legend>Dados do Contato</legend>

									<label for="nome">Nome:</label> 
									<input type="text" id="nome"
										name="nome" size="40" class="form-control" required> <br>
									...
									<input type="tel"
										...
										type="number" id="cpf" name="cpf" size="20"
										class="form-control" required> <br> 
										
										<label
										for="email">Email:</label> <input type="text" id="email"
										name="email" size="50" class="form-control" required>
									<br> 
