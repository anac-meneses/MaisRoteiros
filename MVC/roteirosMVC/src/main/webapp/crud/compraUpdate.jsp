							...
							<div class="card-body p-5" >
								<ul class="nav nav-tabs">
									...
									<li class="nav-item"><a class="nav-link active"
										href="./CompraUpdate">Atualizar</a></li>
								</ul>
								<br>

								<form action="./CompraEdit" class="form-control">
									<legend>Dados para Atualizar</legend>
									
									<label for="idCompra">ID Compra:</label> 
									<input type="text" id="idCompra" name="idCompra" size="40" class="form-control" value="<%=request.getAttribute("idCompra")%>"readonly> <br>

									<label for="cpf">CPF:</label> 
									<input type="text" id="cpf" name="cpf" size="40" class="form-control" value="<%=request.getAttribute("cpf")%>" required> <br>
										
										
									<label for="idPacote"> ID Pacote:</label> 
									<input type="number" id="idPacote" name="idPacote" size="15" class="form-control" value="<%=request.getAttribute("idPacote")%>"
										required> <br> 
									
									<label for="quantidade">Quantidade:</label> 
									<input type="number" id="quantidade" name="quantidade" size="40" class="form-control" value="<%=request.getAttribute("quantidade")%>" required> <br>
									
									<label for="valor">Valor:</label> 
									<input type="number" id="valor" name="valor" size="40" class="form-control" placeholder="O valor é atribuido de acordo com o pacote" readonly> <br>
									
									<label for="data">Data:</label> 
									<input type="text" id="data" name="data" size="40" class="form-control" value="<%=request.getAttribute("data")%>" required> <br>
