						...
						<div class="card-body p-5">
							<ul class="nav nav-tabs">
								<li class="nav-item"><a class="nav-link active"
									href="pacotes.jsp">Cadastrar</a></li>
								<li class="nav-item"><a class="nav-link"
							...
							<br>
							<form action="../PacoteCadastro" method="get" class="form-control">
									<legend>Cadastro Pacotes de viagens</legend>

									<label for="translado">Translado:</label> 
									<input type="text" id="translado"
										name="translado" size="40" class="form-control" required> <br>
										
										
									<label for="hotel">Hotel:</label> 
									<input type="text"
										id="hotel" name="hotel" size="15" class="form-control"
										required> <br> 
										
										<label for="noites">Quantidade de noites:</label> <input
										type="number" id="noites" name="noites" size="20"
										class="form-control" required> <br> 
										
										<label
										for="idDestino">ID Destino:</label> <input type="number" id="idDestino"
										name="idDestino" size="50" class="form-control" required>
									<br> 
									
									
									<label for="preco">Preço:</label> <input
										type="number" id="preco" name="preco" size="50"
										class="form-control" required><br> <button
