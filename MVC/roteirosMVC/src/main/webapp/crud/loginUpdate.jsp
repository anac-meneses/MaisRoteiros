						...
						<div class="card" style="border-radius: 15px;">
							<div class="card-body p-5" >
								<ul class="nav nav-tabs">
									<li class="nav-item"><a class="nav-link"
										href="./crud/login.jsp">Cadastrar</a></li>
									<li class="nav-item"><a class="nav-link "
										aria-current="page" href="./LoginLista">Consulta</a></li>
									<li class="nav-item"><a class="nav-link"		
										href="./crud/homeADM.jsp">Home ADM</a></li>
									<li class="nav-item"><a class="nav-link active"
										href="./LoginUpdate">Atualizar</a></li>
								</ul>
								<br>

								<form action="./LoginEdit" class="form-control">
									<legend>Dados para Atualizar</legend>

									<label for="idLogin">ID:</label> <input type="number" id="idLogin"
										name="idLogin" size="40" class="form-control"
										value="<%=request.getAttribute("idLogin")%>" readonly> <br>


									<label for="permissao">Permissão:</label> <input type="text"
										id="permissao" name="permissao" size="15" class="form-control"
										value="<%=request.getAttribute("permissao")%>" required>
									<br> 
